...
main() {
  ...
  for asset in wizard.html wizard-form.html wizard-backups.html wizard-backup.html wizard-restore.html wizard-schedule.html wizard-runs.html wizard-dashboard.html wizard-vault.html wizard-storage.html wizard-scrub.html; do
